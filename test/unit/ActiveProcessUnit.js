...
let createActiveProcess1 = function () {
    ...
    +-+-+         +-+-+
      ...
      +----> 6 <----+
           +---+
    */
    stage0 = new ActiveProcessStage({roleID: {id : Buffer.from('1')}, kind: 'ByDereg', dereg: '2', stageNum: 0, nextStages: [1], stagesToWaitFor: [], originStagesToWaitFor: [], attachedFilesNames: attachedFilesNames, userEmail: 'a@bgu.ac.il', assignmentTime: today, approvalTime: null, notificationsCycle:1, comments:comments});
    stage1 = new ActiveProcessStage({roleID: {id : Buffer.from('2')}, kind: 'ByDereg', dereg: '3', stageNum: 1, nextStages: [2], stagesToWaitFor: [0], originStagesToWaitFor: [0], attachedFilesNames: attachedFilesNames, userEmail: 'b@bgu.ac.il', assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage2 = new ActiveProcessStage({roleID: {id : Buffer.from('3')}, kind: 'ByRole', dereg: '', stageNum: 2, nextStages: [3], stagesToWaitFor: [1], originStagesToWaitFor: [1], attachedFilesNames: attachedFilesNames, userEmail: null, assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage3 = new ActiveProcessStage({roleID: {id : Buffer.from('2')}, kind: 'ByDereg', dereg: '3', stageNum: 3, nextStages: [4,5], stagesToWaitFor: [2], originStagesToWaitFor: [2], attachedFilesNames: attachedFilesNames, userEmail: 'b@bgu.ac.il', assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage4 = new ActiveProcessStage({roleID: {id : Buffer.from('4')}, kind: 'ByRole', dereg: '', stageNum: 4, nextStages: [6], stagesToWaitFor: [3], originStagesToWaitFor: [3], attachedFilesNames: attachedFilesNames, userEmail: null, assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage5 = new ActiveProcessStage({roleID: {id : Buffer.from('5')}, kind: 'ByRole', dereg: '', stageNum: 5, nextStages: [6], stagesToWaitFor: [3], originStagesToWaitFor: [3], attachedFilesNames: attachedFilesNames, userEmail: null, assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage6 = new ActiveProcessStage({roleID: {id : Buffer.from('1')}, kind: 'Creator', dereg: '', stageNum: 6, nextStages: [], stagesToWaitFor: [4,5], originStagesToWaitFor: [4,5], attachedFilesNames: attachedFilesNames, userEmail: 'a@bgu.ac.il', assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
...
let createActiveProcess2 = function () {
    ...
    +-+-+         +-+-+
      ...
      +----> 6 <----+
           +---+
    */
    stage0 = new ActiveProcessStage({roleID: {id : Buffer.from('1')}, kind: 'ByDereg', dereg: '2', stageNum: 0, nextStages: [1], stagesToWaitFor: [], originStagesToWaitFor: [], attachedFilesNames: attachedFilesNames, userEmail: 'a@bgu.ac.il', assignmentTime:today, approvalTime: today, notificationsCycle:1, comments:comments});
    stage1 = new ActiveProcessStage({roleID: {id : Buffer.from('2')}, kind: 'ByDereg', dereg: '3', stageNum: 1, nextStages: [2], stagesToWaitFor: [], originStagesToWaitFor: [], attachedFilesNames: attachedFilesNames, userEmail: 'b@bgu.ac.il', assignmentTime:today, approvalTime: today, notificationsCycle:1, comments:comments});
    stage2 = new ActiveProcessStage({roleID: {id : Buffer.from('3')}, kind: 'ByRole', dereg: '', stageNum: 2, nextStages: [3], stagesToWaitFor: [], originStagesToWaitFor: [], attachedFilesNames: attachedFilesNames, userEmail: null, assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage3 = new ActiveProcessStage({roleID: {id : Buffer.from('1')}, kind: 'Creator', dereg: '', stageNum: 3, nextStages: [4,5], stagesToWaitFor: [2], originStagesToWaitFor: [2], attachedFilesNames: attachedFilesNames, userEmail: 'a@bgu.ac.il', assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage4 = new ActiveProcessStage({roleID: {id : Buffer.from('4')}, kind: 'ByRole', dereg: '', stageNum: 4, nextStages: [6], stagesToWaitFor: [3], originStagesToWaitFor: [3], attachedFilesNames: attachedFilesNames, userEmail: null, assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage5 = new ActiveProcessStage({roleID: {id : Buffer.from('2')}, kind: 'ByDereg', dereg: '3', stageNum: 5, nextStages: [6], stagesToWaitFor: [3], originStagesToWaitFor: [3], attachedFilesNames: attachedFilesNames, userEmail: null, assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    stage6 = new ActiveProcessStage({roleID: {id : Buffer.from('1')}, kind: 'Creator', dereg: '', stageNum: 6, nextStages: [], stagesToWaitFor: [4,5], originStagesToWaitFor: [4,5], attachedFilesNames: attachedFilesNames, userEmail: 'a@bgu.ac.il', assignmentTime:null, approvalTime: null, notificationsCycle:1, comments:comments});
    let stages = [stage0, stage1, stage2, stage3, stage4, stage5, stage6];
